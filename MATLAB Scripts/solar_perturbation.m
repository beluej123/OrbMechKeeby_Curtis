...
N       = sum([n1,n2]~=1);
Lambda  = bsxfun(@plus,repmat(-2 + 2*cos((0:n2-1) * pi/n2), n1, 1) - 2 + 2 * cos((0:n1-1).' * pi/n1));
W       = ones(n1,n2);
zz      = y;
for k = 1:6
    tol = Inf;
